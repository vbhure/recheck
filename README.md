...
**A caseload agent for veterans' representatives. It re-checks the combined rating in every VA decision letter in a folder, finishes what the letters themselves settle, and brings back only the questions whose answer would change a rating.**
